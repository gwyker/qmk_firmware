...
// TODO
// encoder on shift tab and shift ctl tab
// swap backspace and ctrl/esc
// tap for [] on alt or super or something
// rethink arrow keys
// mouse keys?
